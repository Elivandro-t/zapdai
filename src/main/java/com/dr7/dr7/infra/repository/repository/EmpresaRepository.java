...
public interface EmpresaRepository extends JpaRepository<EmpresaEntity,Long> {
    ...
    @Query("select p from EmpresaEntity p where p.idEmpresa=:idEmpresa and p.nomeCompania=:nomeCompania")
    Optional<EmpresaEntity> buscaEmpresaPorUsuario(@NotNull long idEmpresa, @NotBlank String nomeCompania);
}
